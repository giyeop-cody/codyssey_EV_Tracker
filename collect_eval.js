 ...
 *   3) 평가 목록: ev/request/mbrSearch/searchList — ✅ mbrId 반영 (멤버별 평가 목록 수집)
 ...
 *   node collect_eval.js --members sha1:090dc56a,sha1:f6bca2bc --dry-run   # 소수 테스트
...
/* ---------------- 4) mbrSearch 계열 (mbrId 반영 확정, 2026-07-17) ----------------
...
async function main() {
  ...
  const out = {
    meta: {
      ...
      selfOnlyWarning: false,          // mbrSearch로 멤버별 평가 수집 성공 (2026-07-17 확정)
